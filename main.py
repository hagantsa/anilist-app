...
If it for some reason isn't possible to execute this program because it 
consists of several source files, I have included a combined source file
named anilist_app_COMBINED.py (it doesn't contain this comment, and generally
might not contain everything the separate source files do).
"""

from anilist_app import *


def main():

    # Start the user interface of the app
    AnilistApp()
